...
class AdminLeopartsfilterDeviceController extends ModuleAdminControllerCore
{
    public $mod_config;
    public function __construct()
    {
        ...
        $this->bootstrap = true;
        $this->table = 'leopartsfilter_device';
        $this->identifier = 'id_leopartsfilter_device';
        $this->className = 'LeopartsfilterDevice';
        $this->lang = true;
        $this->addRowAction('edit');
        $this->addRowAction('delete');
        $this->bulk_actions = array('delete' => array('text' => $this->l('Delete selected'), 'confirm' => $this->l('Delete selected items?'), 'icon' => 'icon-trash'));
        $this->fields_list = array(
            'id_leopartsfilter_device' => array(
                'title' => $this->l('ID'),
                'align' => 'center',
        ...
        $this->_select .= ' cl.name make_name, dl.name model_name, yl.name year_name';
        ...
        $this->_group = ' GROUP BY (a.id_leopartsfilter_device) ';
...
//            $breadcrumbs2['tab']['name'] = $tabs[0]['name'].'';
            $breadcrumbs2['tab']['name'] = 'LEVEL 4 MANAGEMENT';
        ...
        $this->breadcrumbs[] = 'LEVEL 4 MANAGEMENT';
    ...
    {
        $this->toolbar_title = $this->l('LEVEL 4 MANAGEMENT');
...
//                    'hint' => $this->l('Invalid characters:').' &lt;&gt;;=#{}'
        ...
        $form['buttons']['save'] = array(
            'name' => 'submitAddleopartsfilter_device',
            'type' => 'submit',
            'title' => $this->l('Save'),
            'class' => 'btn btn-default pull-right',
            'icon' => 'process-icon-save'
    ...
    public function processAdd()
    {
        ...
        if (count($this->errors) <= 0) {
            $mod_model = new LeopartsfilterDevice();
            $this->copyFromPost($mod_model, 'device');
