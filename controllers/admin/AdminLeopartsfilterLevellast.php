...
class AdminLeopartsfilterLevellastController extends ModuleAdminControllerCore
{
    public $mod_config;
    public function __construct()
    {
        ...
        $this->className = 'LeopartsfilterLevellast';
        $this->lang = true;
...
//                    'hint' => $this->l('Invalid characters:').' &lt;&gt;;=#{}'
    ...
    public function processAdd()
    {
        ...
        if (count($this->errors) <= 0) {
            $mod_model = new LeopartsfilterLevellast();
            $this->copyFromPost($mod_model, 'levellast');
